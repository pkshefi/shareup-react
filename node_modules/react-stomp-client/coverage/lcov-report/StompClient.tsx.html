...
<html lang="en">
<head>
    <title>Code coverage report for StompClient.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> StompClient.tsx
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Client, Message } from "@stomp/stompjs";
...
&nbsp;
  private handleStompMessage(stompMessage: Message) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (onMessage) {
...
&nbsp;
  private getNewClient(): Client {
    ...
    return new Client({
      brokerURL: endpoint,
      debug: debugMode ? <span class="branch-0 cbranch-no" title="branch not covered" >console.debug </span>: noOp,
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Dec 11 2019 13:19:09 GMT+0100 (Central European Standard Time)
</div>
</div>
